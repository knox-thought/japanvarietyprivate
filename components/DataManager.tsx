...
const TABLES: TableConfig[] = [
  ...
  },
  {
    ...
    icon: '📅',
    fields: [
      { name: 'customer_id', label: 'ลูกค้า', type: 'number', required: true },
      { name: 'car_company_id', label: 'บริษัทรถ', type: 'number' },
      { name: 'start_date', label: 'วันเริ่มต้น', type: 'date', required: true },
      { name: 'end_date', label: 'วันสิ้นสุด', type: 'date', required: true },
      ...
      { name: 'total_price', label: 'ราคาขาย (¥)', type: 'number' },
