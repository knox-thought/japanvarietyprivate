      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <a
            ...
            className="flex items-center gap-4 p-4 bg-amber-50 hover:bg-amber-100 rounded-lg border border-amber-200 transition-colors"
          >
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        {recentQuotations.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <a href="#/admin/processor" className="inline-block mt-4 text-amber-600 hover:text-amber-700 font-medium">
              สร้าง Quotation แรก →
            </a>
          </div>
        ) : (
